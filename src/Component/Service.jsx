    ...
    return (
        <div>
            <div className={`lg:max-w-2xl lg:h-[250px] lg:mx-auto w-full border border-gray-200 rounded-lg shadow dark:border-gray-700 flex `}>
                <div className="w-1/2">
                    <img className="rounded-t-lg h-full w-64 lg:w-96 lg:h-[250px]" src={ServiceImage} alt="" />
                </div>
                <div className="p-5 w-1/2">
                    ...
                    <div className="flex flex-wrap lg:justify-between items-center">
                        ...
                        <button className='btn lg:my-5 mt-2 btn-secondary text-white'>View Details</button>
                    </div>
                </div>
            </div>
        </div>
